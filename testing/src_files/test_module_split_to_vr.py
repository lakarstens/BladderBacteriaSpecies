...
class test_map_seq_msa(unittest.TestCase):
    """
        ...
        BioPython got confused when an argument in the subprocess list was like this:
            ...
            subprocess.run(["python", "extract_16s_vr.py", "-i bad_clustal_format.aln"]
                                                                  ^
    ...
    def test_script_exists(self):
        ...
        """
        get_files=os.listdir("../../split_to_vr/src_files")
        self.assertIn("extract_16s_vr.py", get_files)
        
    def test_find_resources(self):
                
        get_files=os.listdir("../resource_files")
    ...
    def test_alignio_hates_infile(self):
        ...
        checkit=subprocess.run(["python", "extract_16s_vr.py", "-i", "../../testing/resource_files/bad_clustal_format.aln"], capture_output=True, cwd="../../split_to_vr/src_files")
    ...
    def test_no_ref_seq(self):
        ...
        checkit=subprocess.run(["python", "extract_16s_vr.py", "-i", "../../testing/resource_files/no_ref_seq.aln"], capture_output=True, cwd="../../split_to_vr/src_files")
        
        self.assertEqual(checkit.returncode, 1)
        
    def test_no_excise(self):
        
        checkit=subprocess.run(["python", "../../split_to_vr/src_files/extract_16s_vr.py", "-i", "../../testing/resource_files/good_clustal_format.aln"], capture_output=True)
    ...
    def test_check_output(self):
        ...
        checkit=subprocess.run(["python", "../../split_to_vr/src_files/extract_16s_vr.py", "-i", "../../testing/resource_files/good_clustal_format.aln", "-e", "5,13"], capture_output=True, text=True)
        
        print("\n\targs={}\n\treturn code={}\n\tstdout={}\n\tstderr={}".format(checkit.args, checkit.returncode, checkit.stdout, checkit.stderr))
        
        spl_output=checkit.stdout.strip().split("/")
        new_file="../processed_data/{}/{}".format(spl_output[-2], spl_output[-1])
